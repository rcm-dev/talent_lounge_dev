...
$librarycat = sqlInjectString($_GET['articleId']);
...
Where
  mj_learn_article.la_id = '$librarycat'";
$resultlibcatname = mysql_query($libcatname);
$objectlibcatname = mysql_fetch_object($resultlibcatname);
...
<div id="content">
	...
	<div id="contentContainer">
		...
		<div class="heading">
			<h1 class="heading_title bebasTitle">Entrepreneur Library</h1>
		</div>
		...
		<div class="cnscontainerPlain left">
			...
			<div id="inventcontent">
				...
				<div id="article_container" class="ui-window">
						<div style="float:left; margin-right:10px;">
							<div style="width:75px; height:100px; overflow:hidden;">
								<img src="<?php echo $objectlibcatname->la_visual; ?>" width="75" original-title="Types of Viral Marketing">
							</div>
						</div>
						<div style="float:left;">
							<h3><strong class="bebasTitle"><?php echo ucfirst($objectlibcatname->la_title); ?></strong></h3>
							<h4>Category &rarr; <?php echo ucfirst($objectlibcatname->la_cat_name); ?></strong></h4>
						</div>
						<div class="clear"></div>
						<br/>
						<div id="article_body" style="line-height:20px;">
							<?php echo ucfirst($objectlibcatname->la_body); ?>
						</div>
					<br/>
				</div>

				<div id="related_article_container" style="margin-top:20px" class="ui-window">
						<strong class="bebasTitle">Related Article</strong>
						<ul class="book-ui">
								 ...
								 */
								 ...
								 $sqlRecentArticle = "SELECT
									...
									FROM
									  ...
									  mj_learn_article_category ON mj_learn_article.la_cat_id_fk =
									    mj_learn_article_category.la_cat_id
									WHERE mj_learn_article_category.la_cat_id = '$objectlibcatname->la_cat_id_fk'
									ORDER BY
									  mj_learn_article.la_id
									DESC LIMIT 8";
		...
		<div class="right" style="border:0px solid orange; width: 240px; padding: 5px;">
			...
			<div id="BrowseIdeaMore" style="margin-top:30px">
				<strong id="browseMore01" class="bebasTitle heading_title_two">Categories</strong>
...
<!-- Page Title -->
<input type="hidden" name="page_title" value="<?php echo ucfirst($objectlibcatname->la_title); ?>" id="page_title" />
