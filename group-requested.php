				...
				<div id="connect-container">
					<div id="loadContainer">
						...
						$notiDetail = "SELECT
						  ...
						  mj_notification.noti_to_usr_id,
						  mj_notification.mj_group_id_fk,
						  mj_users.usr_name,
						  mj_users.user_pic,
						  mj_network.mn_name,
						  mj_network.mn_desc
						From
						  ...
						  Inner Join
						  mj_network On mj_notification.mj_group_id_fk = mj_network.mn_id
						Where
						...
						<div class="left" style="margin-left: 15px;">
							<a href="users.php?uid=<?php echo $rowNoTiDetails->noti_request_usr_id_fk; ?>" title="">
							<strong><?php echo $rowNoTiDetails->usr_name; ?></strong></a> invite you to join <strong><?php echo $rowNoTiDetails->mn_name; ?> group. </strong><br>
							<div id="action">
								<?php  

								/* Check status friend */
								$cFriend  = "SELECT * FROM mj_network_relation 
											WHERE usr_id_fk = '$usr_id'
											 AND mn_id_fk = '$rowNoTiDetails->mj_group_id_fk'";
								$rcFriend = mysql_query($cFriend);
								$rowrc    = mysql_fetch_object($rcFriend);

								if ($rowrc->mnr_status == 0) { ?>
									<a href="#" 
										title="Approve" 
										id="approvedStatus" 
										data-gfk="<?php echo $rowNoTiDetails->mj_group_id_fk; ?>" 
								...
								<?php 
									...
									echo '<strong style="color:blue">Is now Joined</strong>';
								}
...
$(document).ready(function(){
	...
	$('#approvedStatus').live('click', function(){
		...
		var friendID   = $(this).attr('data-gfk');
		var approvedBy = $(this).attr('data-usr');

		$.ajax({

			url: "ajax/group_approved.php",
			data: 'groupidfk='+friendID+'&approvedBy='+approvedBy,
			type: "POST",
			...
			success:function(html){
				...
				$.jnotify("You is now joined this group.");
