...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="css/proapp_style.css"/>
...
<title>Career Direction</title>
  </head>
  <body>
  <?php include 'header-sc.php'; ?>
  <div id="tunas-data">
    <strong>Career Direction</strong>
    <small>click or option-click to expand or collapse</small>
...
function toggle(d) {
  if (d.children) {
    ...
    <div style="background:black; margin-top:40px;height:60px; padding-top:20px;">
      <div style="color:white; width:1000px; margin:0 auto;">
        Innovatis Sdn. Bhd. <br>
