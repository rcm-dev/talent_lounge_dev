...
<div id="content" class="">
	...
	<div id="contentContainer" >
		...
		<div class="heading">
			<h2 class="heading_title bebasTitle">Your Action</h2>
		</div>
		...
		<div id="quickToolDashboard" class="right" style="border:0px solid orange; width: 240px; padding: 5px;">
			<strong id="yourAction" class="heading_title_two bebasTitle">Your Contribution</strong>
			<div class="recomAction">
				...
				<a href="#" title="Invent &amp; Influence" class="light_bulb_color" id="s-idea" rel="<?php echo $usr_id; ?>">Idea Section</a>
