  ...
  <script type="text/javascript" src="https://www.google.com/jsapi"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'DMSP Result Chart',
          hAxis: {title: 'DMSP Result Chart', titleTextStyle: {color: '#333'}},
          colors:['red']
        };
...
ul.kerjayaCard li:hover {
    background-color: #fafafa;
}

ul.kerjayaCard li div.cardImage {
    text-align: center;
}

ul.kerjayaCard li div.cardDesc {
  min-height: 250px !important;
}

ul.kerjayaCard li div.cardDesc, ul.kerjayaCard li div.cardSalary, ul.kerjayaCard li h5 {
    padding: 13px;
    margin: 0px;        
}

ul.kerjayaCard li h5 {
  min-height: 70px !important;
}

ul.kerjayaCard li div.cardSalary {
    color: green;
    font-weight: bold;
}
...
<div class="wrapper">
  <div align="center" class="titleBesar">Laporan    Kerjaya</div> 
...
<div id="top">
  <div id= "leftTop"class="left">
    ...
    <div id="call" align="center"><a class="a" href="#S1" ><?php switch ($new_current_disc_1) {
      case 'A':
        echo "D";
        break;
    ...
    <a class="a" name="S2"><?php switch ($new_current_disc_2) {
      case 'A':
        echo "D";
        break;
...
<div id="strength1">
<div class="stegthsBottom"><a name="S1"><img src="img/StrengthsBottom.png"></a></div>

<div id="chart_div2" style="width: 600px; height: 400px;"></div>
<div id="content">
<div id ="active">Gambaran Keseluruhan</div>

<table width="845">
  <tr>
    <td width="412" align="center" class="s"><?php switch ($new_current_disc_1) {
      case 'A':
        echo "D";
        break;
  ...
  <tr>
    <td width="412" align="center" class="s"><?php switch ($new_current_disc_2) {
      case 'A':
        echo "D";
        break;
...
<div id ="active">SYOR KERJAYA - <?php switch ($new_current_disc_1) {
      case 'A':
        echo "D";
        break;
...
<ul class="kerjayaCard">
  ...
  $query_rsJob1 = "SELECT * FROM job WHERE category = '$new_current_disc_1'";
  $result_rsJob1 = mysql_query($query_rsJob1);
  $total_rows_rsJob1 = mysql_num_rows($result_rsJob1);
  

  ?>

  <?php while($row_rsJob1 = mysql_fetch_object($result_rsJob1)) { ?>

  <li>
    <h5><?php echo $row_rsJob1->career; ?></h5>
    <div class="cardImage">
      <img alt="" src="images/job/<?php echo $row_rsJob1->pic; ?>" width="200px" height="200px" style="max-height:200px !important; max-width:200px !important;" />
    </div>
      <div class="cardDesc">
        <strong style="color:#ed7261">Kelayakan</strong>
        <p>
          <?php echo $row_rsJob1->qualification ?>
        </p>
        <strong style="color:orange">Pengalaman</strong>
        <p><?php echo $row_rsJob1->experience ?></p>
      </div>
    <div class="cardSalary">
      <?php echo $row_rsJob1->salary ?>
      <br><br>
      <a href="https://online.mohe.gov.my/upu/onlineupu/ipta/index.php" target="_blank">
        Mohon UPU
      </a>
       &middot; 
       <a href="borang.pdf" target="_blank">
         Muat Turun Borang
       </a>
    </div>
  </li>
...
<div id ="active">SYOR KERJAYA - <?php switch ($new_current_disc_2) {
      case 'A':
        echo "D";
        break;
...
<ul class="kerjayaCard">
  ...
  $query_rsJob2 = "SELECT * FROM job WHERE category = '$new_current_disc_2'";
  $result_rsJob2 = mysql_query($query_rsJob2);
  $total_rows_rsJob2 = mysql_num_rows($result_rsJob2);
  

  ?>

  <?php while($row_rsJob2 = mysql_fetch_object($result_rsJob2)) { ?>

  <li>
    <h5><?php echo $row_rsJob2->career; ?></h5>
    <div class="cardImage">
      <img alt="" src="images/job/<?php echo $row_rsJob2->pic; ?>" width="200px" height="200px" style="max-height:200px !important; max-width:200px !important" />
    </div>
      <div class="cardDesc">
        <strong style="color:#ed7261">Kelayakan</strong>
        <p>
          <?php echo $row_rsJob2->qualification ?>
        </p>
        <strong style="color:orange">Pengalaman</strong>
        <p><?php echo $row_rsJob2->experience ?></p>
      </div>
    <div class="cardSalary">
      <?php echo $row_rsJob2->salary ?>
      <br><br>
      <a href="https://online.mohe.gov.my/upu/onlineupu/ipta/index.php" target="_blank">
        Mohon UPU
      </a>
