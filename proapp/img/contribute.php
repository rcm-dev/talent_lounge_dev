...
<div id="content" class="">
	...
	<div id="contentContainer" >
		...
		<div class="heading">
			<h1 class="heading_title">Your Contribution</h1>
		</div>
				...
				<div id="connect-container">
					<div id="loadContainer">
						...
						<div>
								...
								<div>
									<form action="result_filter.php" method="get" target="_blank">
										<table width="400px" border="0" cellpadding="2" cellspacing="2" style="border-collapse:collapse">
											<tr>
												<td>DMSP</td>
												<td><input type="checkbox" name="a" value="true"> D</td>
												<td><input type="checkbox" name="p" value="true"> M</td>
												<td><input type="checkbox" name="s" value="true"> S</td>
												<td><input type="checkbox" name="c" value="true"> P</td>
											</tr>
							...
							<strong>Profiling Report</strong>
							<br>
							<br>
							<p>
								<?php  
								...
								if ($totalRow_check == 1) {
									echo '<a href="proapp/profile_report.php?uid='.$_SESSION['usr_id'].'" title="Profile Report">Profile Report</a> &middot; <a href="proapp/career-report.php?uid='.$_SESSION['usr_id'].'" title="Career Profiling">Career Profiling</a> ';
								} else {
									echo '<a href="proapp/" title="Take a Test">Take a Test</a>';
								}
						...
						<div id="usual1" class="usual" style="margin-top:20px; display:none"> 
						  <ul> 
						   <!--  <li><a href="#tab1" class="selected">Buy &amp; Sell Goods</a></li> --> 
						    <li><a href="#tab2">How-To Video</a></li> 
		...
		<div id="quickToolDashboard" class="right" style="border:0px solid orange; width: 240px; padding: 5px;">
			<strong id="yourAction" class="heading_title_two">Your Actions</strong>
			<div class="recomAction">
				...
				<a href="howto_video.php" title="How-To Video" class="light_bulb_color" id="s-idea" rel="<?php echo $usr_id; ?>" style="display:none">How-To Video</a>
				<a href="#" title="Showcase" class="zone_money_color" id="s-project" rel="<?php echo $usr_id; ?>" data-name="<?php echo $usr_name; ?>" style="display:none">Showcase</a>
