	...
	<div id="contentContainer">
		...
		<div id="" class="right" style="border:0px solid red; width: 480px;">
			<div id="lastestupdatearticle" class="right ui-window" style="width:440px;">
						<h3 style="margin-bottom:30px;" class="ic_bookmark-black32">LAMAN PENGETAHUAN</h3>
						...
						<div id="" style="text-align:right; padding: 10px 0px; margin-top:15px;">
							...
							<a href="entrepreneur-library.php" title="Entrepreneur Library" style="float:right" class="button green">Resource Library</a>
						</div><!-- /join network -->
						<?php //} ?>
		...
		<div id="topUsers" style="margin-top:20px;">
			<h1 class="heading_title">Rakan NCIA Program</h1>
