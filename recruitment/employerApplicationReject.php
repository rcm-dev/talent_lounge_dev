...
mysql_select_db($database_conJobsPerak, $conJobsPerak);
$query_rsCandidate = sprintf("Select   mj_users.users_fname,   mj_users.users_lname,   jp_jobseeker.jobseeker_id From   mj_users Inner Join   jp_jobseeker On jp_jobseeker.jobseeker_tel = mj_users.users_id Where   jp_jobseeker.jobseeker_id = %s", GetSQLValueString($colname_rsCandidate, "int"));
...
mysql_select_db($database_conJobsPerak, $conJobsPerak);
$query_rsAppsList = sprintf("SELECT mj_users.users_email,   jp_jobseeker.jobseeker_pic,   jp_application.ads_app_date,   mj_users.users_fname,   mj_users.users_lname,   jp_application.js_id_fk,   mj_users.users_id FROM jp_application Inner Join   jp_jobseeker On jp_application.js_id_fk = jp_jobseeker.jobseeker_id Inner Join   mj_users On jp_jobseeker.users_id_fk = mj_users.users_id WHERE jp_application.ads_id_fk = %s", GetSQLValueString($colname_rsAppsList, "int"));
...
mysql_select_db($database_conJobsPerak, $conJobsPerak);
$query_rsCandidateURL = sprintf("Select   mj_users.users_fname,   mj_users.users_lname,   jp_jobseeker.jobseeker_id From   jp_jobseeker Inner Join   mj_users On jp_jobseeker.users_id_fk = mj_users.users_id Where   jp_jobseeker.jobseeker_id = %s", GetSQLValueString($colname_rsCandidateURL, "int"));
