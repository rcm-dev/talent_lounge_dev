...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO jp_jobpreferences (jobP_id, jobP_1, jobP_2, jobP_3, jobP_salary, user_id_fk) VALUES (%s, %s, %s, %s, %s, %s)",
...
?>
	        ...
	        <span class="selectRequiredMsg">Please select work location.</span></span></td>
	      <tr valign="baseline">
	      <td nowrap align="right">Work Industry</td>
	      <td><span id="spryselect2">
	        <select name="jobP_2" class="date">
...
?>
	        ...
	        <span class="selectRequiredMsg">Please select work Industry.</span></span></td>
	      <tr valign="baseline">
	      <td nowrap align="right">Expected Monthly Salary</td>
	      <td><span id="sprytextfield1">
          <input type="text" name="jobP_salary" value="" size="32">
          <span class="textfieldRequiredMsg">A Salary is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
	      </tr>
	    <tr valign="baseline">
	  ...
	  <input type="hidden" name="jobP_id" value="">
