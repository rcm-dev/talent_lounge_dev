...
?>
<h3>New Set of Questions  for <strong><?php echo $row_test_name->test_name; ?></strong></h3>
...
<br><br>
<a href="#" class="newQuestion"><span class="gen-enclosed foundicon-plus"></span> New Question</a> &middot; <a href="#" id="cancelNewQuestion">Cancel</a>
<br><br>
...
<div class="newQuestionContainer" style="display:none">
	<form action="#" id="newQuestion" method="post">
		...
		<textarea name="question_name" id="question_name" cols="30" rows="10"></textarea><br><br>

		<label for="Order"><strong>Question Order</strong></label><br>
		<input type="text" name="question_order" id="question_order"><br>
		<br>
		<input type="hidden" name="test_id" id="test_id" value="<?php echo $test_id ?>">
		<input type="submit" name="submitNewAndSaveQuestion" id="submitNewAndSaveQuestion" class="button green">
	</form>
	<br><br>
</div>
...
<ul class="ListQuestions">
	...
	while($row_rsListQuestions = mysql_fetch_object($result_rsListQuestions)) { ?>
		...
		<li>
			<strong>No.<?php echo $row_rsListQuestions->qno; ?></strong><br><br>
			<h2><?php echo $row_rsListQuestions->qname; ?></h2> 
			[<a href="#" id="deleteQuestion" data-id="<?php echo $row_rsListQuestions->qid ?>">Delete</a>] <br>
			...
			?>
			<br>
			Type <?php echo $row_rsListQuestions->qtype ?> &middot; <i><?php echo $total_rows_rsTotalAnswer ?> Answer(s) [ <a href="#" id="addNewAnswer" data-id="<?php echo $row_rsListQuestions->qid ?>"><span class="gen-enclosed foundicon-plus"></span> Add</a> ]</i>
