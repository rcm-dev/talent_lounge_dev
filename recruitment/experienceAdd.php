      ...
      <table align="center">
        <tr valign="baseline">
          ...
          <td><span id="sprytextfield1">
            <input type="text" name="exp_co_name" value="" size="32">
            <span class="textfieldRequiredMsg">A value is required.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Industry:</td>
          <td><span id="spryselect1">
            <select name="industry_id_fk" class="date">
...
?>
            ...
            <span class="selectRequiredMsg">Please select an industry.</span></span></td>
        <tr>
        <tr valign="baseline">
          <td nowrap align="right">Position Title</td>
          <td><span id="sprytextfield2">
            <input type="text" name="exp_pos_title" value="" size="32">
            <span class="textfieldRequiredMsg">A position is required.</span></span></td>
        </tr>
        <tr valign="baseline">
...
?>
        ...
        <tr valign="baseline">
          ...
          <td><span id="sprytextfield3">
            <input type="text" name="exp_role" value="" size="32">
            <span class="textfieldRequiredMsg">A role is required.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Monthly Salary</td>
          <td><span id="sprytextfield4">
            <input type="text" name="exp_monthlysalary" value="" size="32">
            <span class="textfieldRequiredMsg">A  Salary is required.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right" valign="top">Work Description</td>
          <td><span id="sprytextarea1">
            <textarea name="exp_word_desc" cols="50" rows="5"></textarea>
            <span class="textareaRequiredMsg">A work descriptionis required.</span></span></td>
        </tr>
        <tr valign="baseline">
		...
		<?php } ?>
            ...
            <span id="spryselect2">
            <select name="exp_from_to_y" class="date">
		...
		<?php } ?>
            ...
            <span id="spryselect3">
            <select name="exp_to_y" class="date">
              <option value="">Year</option>
              <?php 
		for($i = 1960; $i <= date('Y'); $i++) { ?>
              <option value="<?php echo $i; ?>"><?php echo $i; ?></option>
