      ...
      <li>
        <div>
              <div>
                ...
                <img src="media/ads/<?php echo $row_rsJobsOpening->ads_pic; ?>" alt="<?php echo ucfirst($row_rsJobsOpening->ads_title) ?>">
              </div>
              <div class="jobs-close">
                Close Date: <strong><?php echo date('d-m-Y', strtotime($row_rsJobsOpening->ads_date_expired)); ?></strong>
              </div>
            </div>
            <div class="job-title">
              <h2><strong><?php echo ucfirst($row_rsJobsOpening->ads_title) ?></strong></h2>
              <p>
                MYR <?php echo $row_rsJobsOpening->ads_salary ?> &middot; <?php echo $row_rsJobsOpening->location_name ?>
              </p>
            </div>
            <div class="job-title" style="border-top:1px solid #eaeaea">
              <table style="color:#7d7d7d; font-size:11px;" width="100%">
                <tr>
                  <td><?php echo $row_rsJobsOpening->emp_name ?></td>
                  <td align="right"><?php echo $row_rsJobsOpening->ads_view ?> Viewed</td>
                </tr>
                <tr>
                  <td colspan="2" align="center">
                    <br>
                    <a href="jobsAdsDetails.php?jobAdsId=<?php echo $row_rsJobsOpening->ads_id ?>" class="tl-btn-blue">Apply Now!</a>
                  </td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
