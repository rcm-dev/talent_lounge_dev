	      ...
	      <h2 class="title">Browse by Location</h2>
			    <div class="location_lists">
                	<ul>
                        ...
                        <?php 
							...
							$parent_id = $row_rsLocation['location_id'];
							$query_child_location = "Select
													  jp_location.*
													From
													  jp_location
													Where
													  jp_location.location_parent = $parent_id";
							$result_cl = mysql_query($query_child_location);
							$total_row = mysql_num_rows($result_cl);
						?>
						<?php if($total_row > 0){ ?>
								<ul>
                                	<?php do { ?>
                                	<li>
                                    <a href="jobsByLocation.php?ads_location=<?php echo $rowObject->location_id; ?>&location=<?php echo $rowObject->location_name; ?>">
									<?php echo $rowObject->location_name; ?>
                                    </a></li>
                                    <?php } while ($rowObject = mysql_fetch_object($result_cl)); ?>
                                </ul>
						<?php } ?>
                        	</li>
			  ...
			  <div class="browse_industry box">
			    ...
			    <div class="industry_lists">
                	<ul>
                    	<?php do { ?>
                    	  <li><a href="jobsByIndustry.php?ads_industry_id_fk=<?php echo $row_rsIndustry['indus_id']; ?>&industry=<?php echo $row_rsIndustry['indus_name']; ?>"><?php echo $row_rsIndustry['indus_name']; ?></a>
                          <?php
						  
						  echo $row_rsIndustry['indus_id'];
			  ...
			  <div class="freatured_employer box">
			    ...
			    <div class="featured_emplyed_lists">
                	<ul>
                    	<?php do { ?>
                   	    <li><a href="employer.php?emp_id=<?php echo $row_rs14FeaturedEmployed['emp_id']; ?>&employer=<?php echo $row_rs14FeaturedEmployed['emp_name']; ?>"><?php echo $row_rs14FeaturedEmployed['emp_name']; ?></a>
                        </li>
