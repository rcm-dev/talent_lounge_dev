...
mysql_select_db($database_conJobsPerak, $conJobsPerak);
$query_rsJobsOpening = "Select   jp_industry.indus_name,   jp_employer.emp_name, jp_employer.emp_pic,  jp_ads.* From   jp_ads Inner Join   jp_industry On jp_ads.ads_industry_id_fk = jp_industry.indus_id Inner Join   jp_employer On jp_ads.emp_id_fk = jp_employer.emp_id Inner Join   jp_location On jp_ads.ads_location = jp_location.location_id Where   jp_ads.ads_enable_view = 1 Order By   jp_ads.ads_date_published Desc";
...
<div class="videosResumeSection">
	<div id="wrapper" style="padding:40px 0px;">
	
	<section id="middle">

		  <div id="content_full" style="padding:0; margin:0;">
        <ul id="video-resume-list-thumbnails">
      <li>
        <video id="example_video_1" class="video-js vjs-default-skin"
          controls preload="auto" width="280" height="200"
