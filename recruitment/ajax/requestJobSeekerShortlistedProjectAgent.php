...
$query_rsViewProjectAppointed = "SELECT * FROM recruit_js_lists 
									...
									WHERE js_id_shortlisted = 1 AND rjs_project_id_fk = " . $viewPID;
...
<html>
<head>
	<title>Jobseeker ShortListed based on Project</title>
...
<h3>This shortlisted lists will be appear to the employer.</h3>
