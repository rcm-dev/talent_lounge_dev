...
<?php if ($total_rows_test == 0): ?>
	<span class="foundation-edit"></span>
	<p>No Test</p>
<?php endif ?>
...
<ul class="testUI">
	<?php while ($row_test = mysql_fetch_object($result_test)) { ?>
		...
		<li>
			<h2><strong><?php echo $row_test->test_name; ?></strong></h2><br>
			Scores <strong><?php echo $row_test->test_score; ?></strong> &middot; View <strong><?php echo $row_test->display; ?></strong> &middot; 
			...
			<?php if ($total_rows_questions == 0) { ?>
				...
				<a href="#" id="createNewQuestion" data-id="<?php echo $row_test->tid; ?>" data-name="<?php echo $row_test->test_name; ?>"><span class="gen-enclosed foundicon-plus"></span> Create Set of Questions</a>
				<br>
				<br>
			<?php } else { ?>
				<strong><?php echo $total_rows_questions ?></strong> Question(s) &middot; 
				<a href="#" id="editQuestion" data-id="<?php echo $row_test->tid; ?>" data-name="<?php echo $row_test->test_name; ?>"><span class="gen-enclosed foundicon-edit"></span> Edit Set of Questions</a> &middot; <a href="preview_assessment.php?tid=<?php echo base64_encode($row_test->tid); ?>" id="previewTest" data-id="<?php echo $row_test->tid; ?>"><span class="gen-enclosed foundicon-website"></span> Preview Test</a>
				<br>
				<br>
			<?php } ?>
		</li>
