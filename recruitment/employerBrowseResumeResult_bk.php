...
$spm_subject_grade = mysql_real_escape_string(@$_GET['spm_subject_grade']);
  ...
  <tr>
    <td>
    	<div id="generalFilter">
	        <form action="" method="get" name="groupFiltering">
        	<table width="580" border="0" cellspacing="0" cellpadding="2">
  <tr>
    <td>Nationality</td>
...
?>
              ...
              <tr>
                ...
                <select name="cgpa" class="date">
                	<option value="1">3.50 and Above</option>
                    <option value="2">3.49 and below</option>
                </select>
                </td>
              </tr>
            </table>
...
?>
                ...
                <tr>
                	...
                	<td><select name="salary" class="date">
                      ...
                      <option value="10000">RM5,000 and Above</option>
                    </select></td>
                </tr>
            </table>
		</form>
