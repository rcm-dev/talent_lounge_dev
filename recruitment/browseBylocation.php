...
$query_rsLocation = "SELECT * FROM jp_location WHERE location_parent = 0 ORDER BY location_name ASC LIMIT 0,14";
...
<body>
  ...
  <div id="state-landings">
    <div class="center">
      <div style="padding: 40px 0px;">
        <h1 class="title" style="font-size:40px; color: white;">Job by Location</h1>
        <p>We cover all Malaysian state</p>
      </div>
      <div>
        <ul id="loc-icon">
          <?php while ($locationView = mysql_fetch_object($rsLocation)) { ?>
            <li class="resumebox">
              <a href="jobsByLocation.php?ads_location=<?php echo $locationView->location_id; ?>&location=<?php echo $locationView->location_name; ?>">
                <div>
                  <img src="../<?php echo $locationView->location_image; ?>" alt="<?php echo $locationView->location_name; ?>" height="130px" width="190px">
                </div>
                <h3><strong><?php echo ucfirst($locationView->location_name); ?></strong></h2>
              </a>
              <p style="color:grey; font-size: 12px;">
                  ...
                  $query_rsTotalJosLists = "SELECT * FROM jp_ads WHERE ads_location = " . $locationView->location_id . " AND ads_enable_view = 1";
