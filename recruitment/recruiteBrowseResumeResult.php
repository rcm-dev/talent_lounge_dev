...
$query_rsJobSeekerList = "Select
  mj_users.*,
  jp_jobseeker.*,
  mj_users.users_type As users_type1,
...
From
  mj_users Inner Join
  jp_jobseeker On mj_users.users_id = jp_jobseeker.users_id_fk
Where
  mj_users.user_active = 1 And
  mj_users.users_type = 1 And
 ...
 ****************************************************************************************/
 ...
 if(($spm_subject_grade != 0 || $spm_subject_grade != NULL) && $spm_subject != 0)
 {
	 $query_rsJobSeekerList = "Select
		...
		From
		  mj_users Inner Join
		  jp_jobseeker On mj_users.users_id = jp_jobseeker.users_id_fk Inner Join
		  jp_spm On jp_spm.user_id_fk = mj_users.users_id
		Where
		  mj_users.users_type = 1 And
		  mj_users.user_active = 1 And
	...
	if($language == 0 && $lang_spoken == 0 && $lang_written == 0)
	 {
		 $query_rsJobSeekerList = "Select
			...
			From
			  mj_users Inner Join
			  jp_jobseeker On mj_users.users_id = jp_jobseeker.users_id_fk Inner Join
			  jp_language On jp_language.user_id_fk = mj_users.users_id
			Where
			  mj_users.users_type = 1 And
			  mj_users.user_active = 1 And
	...
	if($prefer_location == 0 && $industry == 0 && $salary == 0)
	 {
		 $query_rsJobSeekerList = "Select
			...
			From
			  mj_users Inner Join
			  jp_jobseeker On mj_users.users_id = jp_jobseeker.users_id_fk Inner Join
			  jp_jobpreferences On jp_jobpreferences.user_id_fk = mj_users.users_id
			Where
			  mj_users.users_type = 1 And
			  mj_users.user_active = 1 And
	...
	if($graduate_year == 0 && $qualification == 0 && $field_of_study == 0 && $cgpa == 0)
	 {
		 $query_rsJobSeekerList = "Select
			...
			From
			  mj_users Inner Join
			  jp_jobseeker On mj_users.users_id = jp_jobseeker.users_id_fk Inner Join
			  jp_education On jp_education.user_id_fk = mj_users.users_id
			Where
			  mj_users.users_type = 1 And
...
<body>
	...
	<section id="middle">
		  ...
		  <div id="content_full">
<h2>Employer Profile</h2><br>
<div class="master_details_full">
  <?php include("recruiter_menu.php"); ?><br/> 
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" class="csstable2">
  ...
  <?php do { ?>
    <tr>
      ...
      <td align="center" valign="middle"><a href="recruiterViewJobSeekerResume.php?js_id=<?php echo $row_rsJobSeekerList['users_id']; ?>" class="viewResume">View Resume</a></td>
