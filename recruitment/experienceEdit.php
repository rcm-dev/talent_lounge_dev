...
<div class="master_details">
  ...
  <div class="master_details boxcenter">
   ...
   <tr>
     <td>
       <img src="../images/flat/64/briefcase.png" alt="Experience">
     </td>
     <td>
       <h3>List Experience</h3>
     </td>
   </tr> 
  </table>
  <br/>
	<p>There has <?php echo $totalRows_rsUserEmpHistory ?> at your resume.
  ...
  <table width="100%" border="0" cellpadding="4" cellspacing="0" class="csstable2">
      <tr>
        <th>Title</th>
        <th>Company Name</th>
        <th>Edit</th>
      ...
      <tr>
        ...
        <td><a href="experienceEditDetails.php?eid=<?php echo $row_rsUserEmpHistory['exp_id']; ?>&uid=<?php echo $_SESSION['MM_UserID']; ?>">Edit</a></td>
        <td><a href="#">Delete</a></td>
      </tr>
      <?php } while ($row_rsUserEmpHistory = mysql_fetch_assoc($rsUserEmpHistory)); ?>
  </table><br/>
  <br>
  <a href="experienceAdd.php?cuid=<?php echo $_SESSION['MM_UserID']; ?>" class="btn btn-success">Add More Experience</a>
