...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("UPDATE jp_employer SET emp_pic=%s WHERE users_id_fk=%s",
  ...
  // move uploaded file
  if($Result1) {
	  move_uploaded_file($_FILES["resume_path"]["tmp_name"], "media/employer/img/" . $timestamp . "-" . str_replace(" ", "-", $_FILES["resume_path"]["name"]));
  }

  $insertGoTo = "employerProfileEdit.php?cuid=".$_SESSION['MM_UserID'];
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><input type="submit" value="Upload Logo"></td>
        </tr>
      </table>
