...
<div class="master_details">
  ...
  <div class="master_details boxcenter">
   ...
   <tr>
     <td>
       <img src="../images/flat/64/attachment.png" alt="">
     </td>
     <td>
       <h3>File Resume</h3>
       <p>Only doc, docx, pdf, ppt and pptx</p>
     </td>
   </tr> 
  </table>
  <p>&nbsp;</p>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><input type="submit" id="submitResume" class="btn btn-success" value="Upload Resume"></td>
        </tr>
      </table>
