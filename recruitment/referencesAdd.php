...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO jp_references (ref_id, ref_name, ref_relationship, ref_email, ref_phone, ref_pos_title, ref_comp_name, user_id_fk) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['ref_id'], "int"),
                       GetSQLValueString($_POST['ref_name'], "text"),
                       GetSQLValueString($_POST['ref_relationship'], "int"),
...
<div class="master_details">
  ...
  <div class="master_details boxcenter">
	<h3>Add References</h3><br/>
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        <tr valign="baseline">
          <td nowrap align="right">Name:</td>
          <td><input type="text" name="ref_name" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Relationship</td>
          <td><input type="text" name="ref_relationship" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Email</td>
          <td><input type="text" name="ref_email" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Phone</td>
          <td><input type="text" name="ref_phone" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Position Title</td>
          <td><input type="text" name="ref_pos_title" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Company Name</td>
          <td><input type="text" name="ref_comp_name" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">&nbsp;</td>
          <td><input type="submit" value="Add References"></td>
        </tr>
      </table>
