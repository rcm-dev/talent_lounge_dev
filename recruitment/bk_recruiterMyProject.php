...
<div class="master_details_full">
  ...
  <br/>
    ...
    <div id="projectContainerMaster">
      ...
      <div id="projectLists" class="left" style="width:300px; margin-right:10px;">
        <table class="csstable2" width="100%">
          ...
          <?php if ($total_rows_rsAppointedFromEmployer != 0): ?>
            ...
            <?php while ($rows_rsAppointedFromEmployer = mysql_fetch_object($result_rsAppointedFromEmployer)) { ?>
              <tr class="clickableProject" id="<?php echo $rows_rsAppointedFromEmployer->ra_id ?>">
                <td>
                  <strong><?php echo $rows_rsAppointedFromEmployer->ra_title ?></strong> &middot; <i><img src="../images/icon_color/marker.png" alt="Marker"><?php echo $rows_rsAppointedFromEmployer->ra_location ?></i>
                  <br>
                  <img src="../images/icon_color/money-coin.png" alt="money">
      ...
      <div id="projectJobseekerLists" class="right" style="width:690px;">
        <table class="csstable2" width="100%">
          <tr>
            <th>Jobseekers</th>
          </tr>
