...
<body>
	...
	<section id="middle">
		  ...
		  <div id="content_full">
<h2>Find Talent Lounge Jobseeker</h2><br>
<div class="master_details_full">
  <?php include("recruiter_menu.php"); ?><br/> 
<strong>Browse Resume by Filtering</strong><br/>
<p>
  ...
  <tr>
    <td>
    	<div id="generalFilter">
	        <form action="recruiteBrowseResumeResult.php" method="get" name="groupFiltering">
  ...
  <?php do { ?>
    <tr>
      ...
      <td align="center" valign="middle">
          <a href="recruiterViewJobSeekerResume.php?js_id=<?php echo $row_rsJobSeekerList['users_id']; ?>" class="viewResume">View Resume</a>
      </td>
