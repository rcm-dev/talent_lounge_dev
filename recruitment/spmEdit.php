...
<div class="master_details">
  ...
  <div class="master_details boxcenter">
	<p><h3>Edit SPM Subjects</h3>     <a href="spmAdd.php">Add Subject</a> &middot; .   <a href="jobSeekerMyResume.php">My Resume</a> &middot; </p> <br/> 
	<table width="100%" border="0" cellspacing="0" cellpadding="2" class="csstable2">
	  <tr>
	    <th>Subject</th>
	    <th>Grade</th>
	    <th>Edit</th>
	  ...
	  <?php do { ?>
	    <tr>
	      ...
	      <td align="center" valign="middle"><a href="spmEditDetails.php?spmid=<?php echo $row_rsJsSPM['spm_id']; ?>">Edit</a></td>
	      </tr>
