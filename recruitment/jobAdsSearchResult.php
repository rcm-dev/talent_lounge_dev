...
<body>
	...
	<section id="middle">
		  ...
		  <div id="content" style="width:610px; padding-top:10px;margin-top:30px;">
          	  <h2 class="title">Your Search Result</h2>
              <p>There are (<?php echo $totalRows_rsQueryJob ?>) Job(s) in your search</p>
    ...
    <?php do { ?>
      <li>
        <div style="float:left; width:400px;">
          <div><a href="jobsAdsDetails.php?jobAdsId=<?php echo $row_rsQueryJob['ads_id']; ?>"><h2><?php echo ucfirst($row_rsQueryJob['ads_title']); ?></h2></a> <br/>
            Industry: <a href="jobsByIndustry.php?ads_industry_id_fk=<?php echo $row_rsQueryJob['ads_industry_id_fk']; ?>&industry=<?php echo $row_rsQueryJob['indus_name']; ?>"><?php echo $row_rsQueryJob['indus_name']; ?></a></div>
          <div><a href="employer.php?emp_id=<?php echo $row_rsQueryJob['emp_id_fk']; ?>&employer=<?php echo $row_rsQueryJob['emp_name']; ?>">Employer: <?php echo $row_rsQueryJob['emp_name']; ?></a></div>
          <div>Salary: RM <?php echo $row_rsQueryJob['ads_salary']; ?></div>
          <div>Experience: <?php echo $row_rsQueryJob['ads_y_exp']; ?> Year(s)</div>
        </div>
        <div style="float:right; width:160px; height:100px; text-align: center;">
          <img src="media/employer/img/<?php echo $row_rsQueryJob['emp_pic']; ?>" alt="<?php echo $row_rsJobsOpening['emp_name']; ?>" width="100px">
        </div>
