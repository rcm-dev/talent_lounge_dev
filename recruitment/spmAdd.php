...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO jp_spm (spm_id, user_id_fk, spm_subject_id_fk, spm_grade) VALUES (%s, %s, %s, %s)",
...
do {  
?>
            <option value="<?php echo $row_rsSubject['subject_id']?>" ><?php echo $row_rsSubject['subject_name']?></option>
            <?php
...
?>
      ...
      <input type="hidden" name="spm_id" value="">
