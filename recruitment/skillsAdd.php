...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO jp_skills (skills_id, skills_name, skills_y_exp, skills_proficiency, user_id_fk) VALUES (%s, %s, %s, %s, %s)",
      ...
      <table align="center">
        <tr valign="baseline">
          ...
          <td><span id="sprytextfield1">
            <input type="text" name="skills_name" value="" size="32">
            <span class="textfieldRequiredMsg">A value is required.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Year Experience</td>
          <td><span id="sprytextfield2">
          <input type="text" name="skills_y_exp" value="" size="32">
          <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Proficiency</td>
          <td><span id="sprytextfield3">
          <input type="text" name="skills_proficiency" value="" size="32">
          <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">&nbsp;</td>
          <td><input type="submit" value="Add Skills"></td>
        </tr>
      </table>
