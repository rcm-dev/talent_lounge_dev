...
mysql_select_db($database_conJobsPerak, $conJobsPerak);
$query_rsShortlistedCandidate = "SELECT jp_ads.ads_title,   jp_jobseeker.users_id_fk,   mj_users.users_fname,   mj_users.users_lname,   mj_users.users_email,   jp_shortlisted.employer_id_fk, jp_shortlisted.joseeker_id_fk, jp_shortlisted.ads_id_fk FROM jp_shortlisted Inner Join   jp_ads On jp_shortlisted.ads_id_fk = jp_ads.ads_id Inner Join   jp_jobseeker On jp_shortlisted.joseeker_id_fk = jp_jobseeker.jobseeker_id   Inner Join   mj_users On jp_jobseeker.users_id_fk = mj_users.users_id WHERE jp_shortlisted.employer_id_fk = $currentEmployedId And   jp_shortlisted.is_reject = 0 And   jp_shortlisted.is_approve = 0  ORDER BY jp_ads.ads_title";
