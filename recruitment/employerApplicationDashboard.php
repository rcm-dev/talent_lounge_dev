    ...
    <?php do { ?>
      <tr>
        ...
        if ($row_rsPremiumCheck['usr_lvl'] == 0) { ?>
          <td><?php echo $row_rsAppsList['users_fname']; ?> <?php echo $row_rsAppsList['users_lname']; ?></td>
        <?php } else { ?>
