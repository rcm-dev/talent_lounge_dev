...
<div class="master_details_full">
  ...
  <br/>
    ...
    <div id="projectContainerMaster">
      
      <div id="projectLists" style="margin-right:10px;">
        <table class="csstable2" width="100%">
          ...
          <?php if ($total_rows_rsAppointedFromEmployer != 0): ?>
            ...
            <?php while ($rows_rsAppointedFromEmployer = mysql_fetch_object($result_rsAppointedFromEmployer)) { ?>
              <tr class="" id="<?php echo $rows_rsAppointedFromEmployer->ra_id ?>">
                <td align="left" valign="middle">
                  <div class="left" style="margin-right:20px">
                    <img src="media/employer/img/<?php echo $rows_rsAppointedFromEmployer->emp_pic ?>" alt="<?php echo $rows_rsAppointedFromEmployer->emp_name ?>" style="max-width:80px;">
                  </div>
                  <div class="left">
                    <strong><?php echo $rows_rsAppointedFromEmployer->emp_name ?></strong>
                  </div>
                  <div class="clear"></div>
                </td>
                <td align="center" valign="middle">
                  <strong><?php echo $rows_rsAppointedFromEmployer->ra_title ?></strong>
                </td>
                <td align="center" valign="middle">
                  RM <?php echo $rows_rsAppointedFromEmployer->ra_salary_range_1 ?> <i>to</i> RM <?php echo $rows_rsAppointedFromEmployer->ra_salary_range_2 ?>
                </td>
                <td align="center" valign="middle">
                  <?php echo $rows_rsAppointedFromEmployer->ra_location ?>
                </td>
                <td align="center" valign="middle">
                  <a href="ajax/requestJobSeekerProjectAgent.php?viewPID=<?php echo $rows_rsAppointedFromEmployer->ra_id ?>" class="clickableProject">
                    View Lists</a>
                </td>
                <td align="center" valign="middle">
                  <a href="ajax/requestJobSeekerShortlistedProjectAgent.php?viewPID=<?php echo $rows_rsAppointedFromEmployer->ra_id ?>" class="clicableShortlistedProject">View Shorlisted</a>
                </td>
              </tr>
            <?php } ?>
      ...
      <div id="projectJobseekerLists" class="right" style="width:690px; display:none;">
        <table class="csstable2" width="100%">
          <tr>
            <th>Jobseekers</th>
          </tr>
          ...
          <?php if ($total_rows_rsAppointedFromEmployer != 0): ?>
            ...
            <tr style="background:white;">
              <td align="center">
                <div id="listOfJobseekerProjectContainer">
                  Click on left to view Jobseeker.
                </div>
              </td>
            </tr>
  ...
  $(document).ready(function() {
    ...
    // $('tr.clickableProject').click(function(){

    //   var viewProjectID = $(this).attr('id');
    //   var viewContainer = $('div#listOfJobseekerProjectContainer');

    //   $.ajax({
    //     url: 'ajax/requestJobSeekerProjectAgent.php?viewPID='+viewProjectID,
    //     method: 'GET',

    //     success:function(data){
    //       viewContainer.text('Loading..').html(data);
    //       // console.log(data);
    //     }
    ...
    $('a.clicableShortlistedProject').fancybox({
      'width':650,
      'height':500,
      'type'        : 'iframe',
      'autoScale'       : 'false'
