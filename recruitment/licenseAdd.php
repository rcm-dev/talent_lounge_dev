...
<div class="master_details">
  ...
  <div class="master_details boxcenter">
   ...
   <tr>
     <td>
       <img src="../images/flat/64/certificate.png" alt="License">
     </td>
     <td>
       <h3>Add New Licenses</h3>
     </td>
   </tr> 
  </table>
  <br/>
      ...
      <table align="center">
        <tr valign="baseline">
          ...
          <td><span id="spryselect1">
            <select name="license_type" class="date">
            ...
            <span class="selectRequiredMsg">Please select the licenses.</span></span></td>
        <tr>
        <tr valign="baseline">
          <td nowrap align="right">&nbsp;</td>
          <td><input type="submit" class="btn btn-success" value="Add License"></td>
        </tr>
      </table>
