...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE jp_language SET lang_name=%s, lang_written=%s, lang_spoken=%s, user_id_fk=%s WHERE lang_id=%s",
...
if (isset($_GET['lang_id'])) {
  $colname_rsUserLanguage = $_GET['lang_id'];
}
mysql_select_db($database_conJobsPerak, $conJobsPerak);
$query_rsUserLanguage = sprintf("SELECT * FROM jp_language WHERE lang_id = %s", GetSQLValueString($colname_rsUserLanguage, "int"));
...
?>
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="lang_written" value="<?php echo $row_rsUserLanguage['lang_written']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Spoken</td>
          <td><input type="text" name="lang_spoken" value="<?php echo $row_rsUserLanguage['lang_spoken']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">&nbsp;</td>
          <td><input type="submit" value="Update Language"></td>
        </tr>
      </table>
      <input type="hidden" name="lang_id" value="<?php echo $row_rsUserLanguage['lang_id']; ?>">
