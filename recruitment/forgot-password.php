...
<div class="master_details">
	<p>Enter your email address</p>
    	<form action="sent-forgot-password.php" method="post" name="forgot-password">
        <table width="600" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td align="right" valign="middle">Email</td>
    <td align="left" valign="middle"><label for="forgotemail"></label>
      <input type="text" name="forgotemail" id="forgotemail" placeholder="valid@email.com"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><input type="submit" name="button" id="button" value="Reset Password"></td>
    <td>&nbsp;</td>
  </tr>
</table>
