...
<div class="master_details">
  ...
  <div class="master_details boxcenter">
	<h3>List Languages</h3><br/>
	<p>There has <?php echo $totalRows_rsUserLanguage ?>&nbsp; at your resume</p>
    <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0" class="csstable2">
      ...
      <?php do { ?>
        <tr>
          <td align="center" valign="middle"><?php echo $row_rsUserLanguage['languList_name']; ?></td>
          ...
          <td align="center" valign="middle"><a href="languageEditDetails.php?lang_id=<?php echo $row_rsUserLanguage['lang_id']; ?>&uid=<?php echo $_SESSION['MM_UserID']; ?>">Edit</a></td>
          <td align="center" valign="middle"><a href="#">Delete</a></td>
        </tr>
        <?php } while ($row_rsUserLanguage = mysql_fetch_assoc($rsUserLanguage)); ?>
    </table>
    <br/>
    <a href="languageAdd.php?cuid=<?php echo $_SESSION['MM_UserID']; ?>">Add More Experience</a> </div>
</div>
