...
<div id="user-panel" class="right" style="height:100px; background: none; line-height: 90px;">
	<a href="../register.php" title="Free to register" id="iregister" class="fancybox ui-user" style="margin-right: 30px; color: white !important">
		Join Now!</a>
	
	<a href="../login.php" title="Login" id="ilogin" class="ui-edit" style="color: white !important; margin-right: 20px">
		Sign In</a>
</div><!-- /right -->
...
<div id="user-panel" class="right" style="border:0px solid orange; width: 180px; padding: 0px 10px; margin-top:0px !important;">
	...
	<div class="left" style="border:0px solid blue;">
		...
		<div class="4rad" style="width:18px height:18px; margin-top:0px; margin-right:5px; width:190px; text-align:right;">
			...
			<div style="float:right; text-align:left; margin-top:10px; border:0px solid red; width: 120px;">
				<span style="color:white; font-size:12px">Welcome</span> <br><span style="color:white; font-size:12px"><?php echo $usr_name; ?></span>
				<br><small style="color:orange; font-size:11px">My Profile</small>
			</div>
	...
	<div class="right" style="border:0px solid red; width: 110px;">
		<div class="left" style="padding-right:10px;">
			<a href="../notification.php?id=<?php echo $usr_id; ?>" id="notification">
			<div class="left">
