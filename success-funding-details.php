			...
			<div class="home_box">
				...
				<div class="details-container" style="border:0px solid red; margin:30px 0px 0px 0px;">
					...
					<div class="right-side bottomshadow">
						...
						<div class="fundingmention" style="background-color: green !important; font-weight: strong; color: white;">
						<p>THIS PROJECT HAS BEEN SUCCESSFUL FUND<br/>
						WITH <strong>RM<?php echo number_format($rowtotalPledged->totalFunded); ?></strong> <span class="none">IS PLEDGED BY <strong><?php echo date("d/m/Y", strtotime($rowqProDetails->fund_post_ended1)); ?></strong></span>.</p>
						</div>
