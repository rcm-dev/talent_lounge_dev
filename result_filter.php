				...
				<?php while ($rows_filter = mysql_fetch_object($result_filter)) { ?>
					...
					<li>
						...
						<div style="float:right; height:100%; width:320px;">
							...
							<br>
							<strong>View:</strong> <span><a href="proapp/report_employer.php?uid=<?php echo $rows_filter->user_id_fk; ?>" title="Employer Report" target="_blank">Employer Report</a></span> &middot; <span><a href="proapp/career.php?uid=<?php echo $rows_filter->user_id_fk; ?>" title="Career Report" target="_blank">Career Report</a></span>
							<br>
							<strong>Action:</strong> <a href="recruitment/employerApplicationShorlistedDirect.php?candidateID=<?php echo $rows_filter->user_id_fk; ?>&employer_id=<?php echo $_SESSION['MM_UserID'] ?>"><span>Shortlist Jobseeker</span></a>
